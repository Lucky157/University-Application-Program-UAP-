...
<nav id="nav-menu-container">
			...
			<div class="whole-wrap">
				...
				include_once 'connect.php';
				$sql0 = "select fullname, AID from applicant, application where applicant.IDNumber = application.IDNumber
				and AID = '$AID'";
				...
				$result = mysqli_query($con, $sql);
				    while($row = mysqli_fetch_assoc($result)){ 
						...
						$sql1 = "select subjectName, grade, score from result
						where QID = '$qid'";
